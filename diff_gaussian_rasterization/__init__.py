...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        num_rendered, color, radii, geomBuffer, binningBuffer, imgBuffer, invdepths, pixel_to_gaussians = _C.rasterize_gaussians(*args)
        ...
        return color, radii, invdepths, pixel_to_gaussians

    @staticmethod
    def backward(ctx, grad_out_color, _, grad_out_depth, pixel_to_gaussians):
